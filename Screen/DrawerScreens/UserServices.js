...
import ResidentCell from './ServiceCell'
...
const ProfileScreen = () => {
  ...
  const EXAMPLE_DATA = [
    {
      ...
      center: 'Toronto North',
    },
    {
      day: '11-05-2022 15:00',
      speciality: 'Surgery',
      center: 'Toronto North',
    },
  ]
  ...
  const fetchData = () => {
    ...
    const renderItem = ({ item }) => (
        <ResidentCell servDate={item.day} servSpeciality={item.speciality} servCenter={item.center}
         />
      );
